...
public:
  ...
  : Node("lower_duty_node")
  {
    ...
    declare_parameter<double>("steer_norm_lpf_alpha", 0.2);
    ...
    declare_parameter<bool>("mavlink_enable", false);
    ...
    declare_parameter<bool>("mavlink_auto_arm", false);
    declare_parameter<bool>("mavlink_force_arm", false);
